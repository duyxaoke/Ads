...
namespace Cash4Aff.Presentation.Controllers.Api
{
    ...
    public class BanksController : ApiControllerBase
    {
        ...
        public BanksController(IBankAppService service)
        {
            _service = service;
        }

        [HttpGet]
        [ResponseType(typeof(IEnumerable<BankViewModel>))]
        ...
        [HttpGet]
        [Route("{id:int}")]
        [ResponseType(typeof(BankViewModel))]
        ...
        public IHttpActionResult Post([FromBody]BankViewModel model)
        {
        ...
        [ResponseType(typeof(void))]
        [EnableThrottling(PerSecond = 1)]
        public IHttpActionResult Put([FromBody]BankViewModel model)
        {
            if (!ModelState.IsValid)
            {
                var errors = new List<string>();
